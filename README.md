...
Este es un proyecto propietario y cerrado. No se aceptan contribuciones externas
no solicitadas.

## 📄 Licencia

Este proyecto es propiedad exclusiva de su autor. Todos los derechos reservados.
Ver el archivo [LICENSE](LICENSE.md) para más detalles sobre las restricciones
de uso.
